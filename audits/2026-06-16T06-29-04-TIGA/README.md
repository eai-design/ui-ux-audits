...
This package was generated locally by UI/UX Internal Monitor v2.3.0.
...
- `DESIGN.md`: token-driven design summary
- `SKILL.md`: AI Skill context instructions
- `README.md`: this file
...
```text
請根據產品介紹、screenshots/*.png、ux-monitor.json、snapshots-manifest.json、snapshots/*.html、DESIGN.md、SKILL.md，針對完整操作路徑做高保真 UI/UX 改版。
要求生成 Before/After 對比、selector 級 diff、icon 替換表、Design Token Diff，以及完整可用 HTML/CSS/JS。
```
